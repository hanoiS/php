		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-xs-2">
					<div id="fh5co-logo"><a href="index.php">Tú Anh</a></div>
				</div>
				<div class="col-md-6 col-xs-6 text-center menu-1">
					<ul>
						<li class="has-dropdown">
							<a href="product.php">Hello</a>
							<ul class="dropdown">
								<li><a href="single.php">TEST</a></li>
							</ul>
						</li>
						<li><a href="about.php">Test</a></li>
						<li class="has-dropdown">
		...
		<div class="container">
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">Tú Anh</small> 
					<!--
